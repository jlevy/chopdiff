...
| cli-agent-skill-patterns | How to write skills and agent-integrated CLIs that work across Codex, Codex, and the broader coding-agent ecosystem — a simple baseline plus references for advanced, multi-subcommand tools |
