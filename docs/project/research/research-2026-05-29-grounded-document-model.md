...
**Companion:** [research-2026-05-29-document-model-layering.md](research-2026-05-29-document-model-layering.md)
adds the model/serialization/implementation separation, collapses the visual-UI and
multi-view axes into one model→views requirement, and covers prior art not surveyed here
(stand-off annotation, lossless/red-green trees, CRDTs, block-JSON editors, djot).
