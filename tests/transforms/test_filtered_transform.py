...
def _to_goodbye(_doc: FlexDoc) -> FlexDoc:
    return FlexDoc.from_text("goodbye")


def _identity(doc: FlexDoc) -> FlexDoc:
    return doc
...
def test_filtered_transform_does_not_mutate_input():
    doc = FlexDoc.from_text("First one. Second two.")
